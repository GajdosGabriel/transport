    ...
    <div class="row mb-4">
        <div class="col-lg-6 d-flex flex-column  mb-4">
            ...
            <p class="card-text text-center mt-auto">
                <a target="_blank" href="https://www.pymnts.com/news/delivery/2020/food-delivery-companies-turn-to-grocery-delivery/" class="btn btn-primary">Read more</a>
            </p>
        </div>
        ...
        <div class="col-lg-6 d-flex flex-column  mb-4">
            ...
            <p class="card-text text-center mt-auto">
                <a target="_blank" href="https://www.digitalcommerce360.com/2020/03/30/online-grocery-shopping-soars-during-the-coronavirus-crisis/" class="btn btn-primary">Read more</a>
            </p>
        </div>
